...
Generating header files from \texttt{defghi} is simple since the differences in declarations are syntactic.  Any type, global variable, or function marked \texttt{export} has its declation unparsed into C and pretty-printed into the target header.
